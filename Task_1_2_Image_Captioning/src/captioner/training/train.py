...
from captioner.training.utils import EarlyStopping, TrainingHistory, save_checkpoint, set_global_seed
...
def train_model(
    ...
    # Seed everything (Python random, NumPy, PyTorch CPU/CUDA) and get back
    # a seeded generator for the shuffling DataLoader below, so weight
    # init, dropout, and batch ordering are reproducible across runs.
    generator = set_global_seed(cfg.project.seed)
